...
urlpatterns = [
    ...
    path('manager/tenant_confirming/', manager_views.tenant_confirming_view, name='ten'
                                                                                  'ant_confirming'),
    ...
    path('forum/discussion/<int:discussion_id>/'
         'thread/<int:thread_id>', tenant_views.thread_view, name="thread"),
    path('forum/<int:forum_id>/'
         'cr_discussion', tenant_views.cr_discussion_view, name="cr_discussion"),
    path('forum/<int:forum_id>/'
         'category/<str:category_name>', tenant_views.category_view, name="category"),
    ...
    path('registration/manager', manager_views.registration_manager, name="reg_manager"),
